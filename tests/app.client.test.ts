...
test("sign Tx", async () => {
  const replay: string =
    ...
    "<= 9000" +
    "\n" +
    "=> " +
    "\n" +
    "<= 9000" +
    "\n" +
    "=> 5a03030000" +
...
test("sign DeployAccount", async () => {
  const replay: string =
    ...
    "<= 9000" +
    "\n" +
    "=> " +
    "\n" +
    "<= 9000" +
    "\n" +
    "=> 5a05030000" +
